  ...
  return (
    <View style={[styles.container, { marginTop: statusBarHeight }]}>
      ...
      <View style={styles.subContainer2}>
        <Text  style={{ fontSize:16, color:'#0f294c', width:'100%', marginBottom:10}} >Recibidos</Text>

        <View style={{width:'100%', flexDirection: 'row', gap:15, paddingVertical: 10}}>
          ...
          <View style={{  justifyContent:'center'}}>
            <Text style={{ justifyContent:'center', fontSize:20, color:'#0f294c'}} >Michael Vera</Text>
            <Text style={{ justifyContent:'center', fontSize:12, color:'#0f294c'}}>Se hace llamado para el pollito</Text>
